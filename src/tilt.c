...
int
freenect_set_tilt_degs(freenect_device *dev, double angle)
{
	int ret;
	uint8_t empty[0x1];
...
int
freenect_set_led(freenect_device *dev, freenect_led_options option)
{
	int ret;
	uint8_t empty[0x1];
...
void
freenect_get_mks_accel(freenect_raw_tilt_state *state, double* x, double* y, double* z)
{
